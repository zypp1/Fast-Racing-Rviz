...
int main(int argc, char **argv)
{
    ...
    Eigen::Vector3d test_circle_pos;
    test_circle_pos = {0,8,2};
    gate_list.emplace_back(test_circle_pos);
    test_circle_pos = {2,6,1};
    gate_list.emplace_back(test_circle_pos);
    test_circle_pos = {0,-8,2};
    gate_list.emplace_back(test_circle_pos);
    test_circle_pos = {-8,0,1};
    gate_list.emplace_back(test_circle_pos);
    ...
    target_pt = Eigen::Vector3d(0, 0, 1);
    std::cout<<"goal: "<<target_pt.transpose()<<std::endl;
